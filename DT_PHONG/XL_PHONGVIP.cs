...
namespace DT_PHONG
{
    ...
    public class XL_PHONGVIP
    {
        ...
        public static void capNhatPhong(PHONGVIP p, string ghiChu = "Cap nhat thong tin phong: ")
        {
            Console.WriteLine(ghiChu);
            Console.Write("Nhap ten phong: ");
        ...
        {
            boGhi.WriteLine(string.Format("v,{0},{1},{2},{3}", p.maPhong, p.tenPhong, p.donGia, p.soGiuong));
        }
